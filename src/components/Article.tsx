...
const Article = ({props} : PropsData) => {
    return (
        <Link key={props.id} href={`/articles/${props.slug}`}>
            <div className="w-[80vw] md:w-[30vw] max-w-[500px] border-2 rounded border-gray-50 dark:border-gray-900 overflow-hidden hover:cursor-pointer font-formula text-sm">
                <Image
